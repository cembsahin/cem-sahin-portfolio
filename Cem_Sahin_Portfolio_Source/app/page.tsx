const experience = [
  {
    ...
    highlights: [
      ...
      "Created an agent that turns undocumented support issues into Confluence articles, closing knowledge gaps without manual authoring.",
      "Developed Python Slack bots with the Claude API and built an asset management system covering approximately 2,000 devices.",
    ],
  },
  {
    company: "MongoDB",
